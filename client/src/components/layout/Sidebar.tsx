...
export function Sidebar({ className }: { className?: string }) {
  ...
  return (
    <div className={cn("flex h-screen w-64 flex-col bg-[#2d7438] dark:bg-[#262626] text-sidebar-foreground", className)}>
      <div className="hidden md:flex h-20 items-center justify-center bg-[#2d7438] dark:bg-[#262626]">
        <Link href="/dashboard">
          <img 
      ...
      <div className="flex-1 overflow-y-auto pb-4 pt-0 bg-[#2d7438] dark:bg-[#262626]">
      ...
      {pigBankItems.length > 0 && (
        <div className="border-t border-white/10 px-3 py-3 bg-[#2d7438] dark:bg-[#262626]">
      ...
      <div className="border-t border-white/10 p-2 bg-[#2d7438] dark:bg-[#262626]">
        <a 
          href="/landing" 
