...
function FlipCard({
  ...
  if (prefersReducedMotion) {
    return (
      ...
      >
        <div
          className={`absolute inset-0 bg-[#2f8a2b] rounded-2xl shadow-lg p-4 flex flex-col items-center justify-center transition-opacity duration-300 overflow-hidden ${
        ...
        <div
          className={`absolute inset-0 bg-[#2f8a2b] rounded-2xl shadow-lg p-6 flex flex-col items-center justify-center transition-opacity duration-300 ${
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="absolute inset-0 bg-[#2f8a2b] rounded-2xl shadow-lg hover:shadow-xl p-4 flex flex-col items-center justify-center overflow-hidden"
        ...
        <div
          className="absolute inset-0 bg-[#2f8a2b] rounded-2xl shadow-lg hover:shadow-xl p-6 flex flex-col items-center justify-center"
          style={{
...
export default function PaymentMethodsFlip() {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-12 md:py-16 bg-[#e1f7b1] relative overflow-hidden"
