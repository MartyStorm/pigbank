...
function FlipCard({
  ...
  if (prefersReducedMotion) {
    return (
      ...
      >
        <div
          className={`absolute inset-0 bg-[#e6f8d0] rounded-2xl shadow-lg p-4 flex flex-col items-center justify-center transition-opacity duration-300 ${
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="absolute inset-0 bg-[#e6f8d0] rounded-2xl shadow-lg hover:shadow-xl p-4 flex flex-col items-center justify-center"
