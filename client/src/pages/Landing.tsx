            ...
            <div className="animate-marquee whitespace-nowrap flex items-center">
              {[...Array(3)].map((_, i) => (
                <div key={i} className="flex items-center">
                  <span className="text-base font-semibold text-white uppercase tracking-wider mx-6">SHOPIFY</span>
                  <span className="text-white/60 mx-2">•</span>
                  <span className="text-base font-semibold text-white uppercase tracking-wider mx-6">WOOCOMMERCE</span>
                  <span className="text-white/60 mx-2">•</span>
                  <span className="text-base font-semibold text-white uppercase tracking-wider mx-6">WORDPRESS</span>
                  <span className="text-white/60 mx-2">•</span>
                  <span className="text-base font-semibold text-white uppercase tracking-wider mx-6">WIX</span>
                  <span className="text-white/60 mx-2">•</span>
                  <span className="text-base font-semibold text-white uppercase tracking-wider mx-6">SQUARESPACE</span>
                  <span className="text-white/60 mx-2">•</span>
