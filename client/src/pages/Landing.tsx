  ...
  return (
    <>
      ...
      <div 
        className="relative"
        style={{
          background: 'radial-gradient(ellipse at center, #4a8b4d 0%, #3a6b3d 35%, #2d5a30 60%, #1a4320 100%)'
        }}
      >
                ...
                <div className="relative pl-[40px] md:pl-[55px] lg:pl-[70px] xl:pl-[80px]">
                  ...
                  <div className="w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden bg-[#2f8a2b] flex items-center justify-center">
                    <img 
                      ...
                      className="w-40 md:w-52 h-auto object-contain translate-y-[9%] translate-x-[-2%] scale-[1.77]"
                    />
                  </div>
                </div>
              </div>
                ...
                <div className="relative pl-[35px] md:pl-[45px] lg:pl-[55px] xl:pl-[65px]">
                  ...
                  <div className="w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden bg-[#2f8a2b] flex items-center justify-center">
                    <img 
                      ...
                      className="w-56 md:w-72 h-auto object-contain scale-[1.15] translate-x-[-5%] translate-y-[2%]"
                    />
                  </div>
                </div>
              </div>
        ...
        <section className="py-12 md:py-16 lg:py-32 relative overflow-hidden bg-[#eafacf]">
          ...
          <div className="container px-4 md:px-6 max-w-7xl mx-auto relative z-10">
            <div className="flex flex-col lg:flex-row items-stretch gap-6 md:gap-8 lg:gap-20">
              ...
              <div className="lg:w-1/2 order-1 lg:order-2 space-y-4 md:space-y-5 lg:space-y-6 text-center flex flex-col items-center justify-start lg:justify-center pt-0 pb-2 md:pb-4 lg:py-0">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900">
        ...
        <section className="py-16 md:py-24 bg-[#effad6]">
          <div className="container px-4 md:px-6 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row gap-4 lg:min-h-[520px]">
              ...
              {/* High Risk Card */}
              <div 
                className="group relative flex-1 rounded-3xl p-8 md:p-10 overflow-hidden lg:cursor-pointer transition-all duration-500 lg:hover:flex-[1.5] bg-[#1a4320]"
