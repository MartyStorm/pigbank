            ...
            >
              <div className="flex flex-col items-center text-center gap-6">
                <div className="space-y-4">
                  <h1 className="hero-title font-bold tracking-tight text-[#4576c9]" style={{ textShadow: '0 2px 8px rgba(255,255,255,0.3)' }}>
                    Built for Business, Payment Processing
                  </h1>
                  <p className="text-xl md:text-2xl text-[#4576c9] font-semibold" style={{ textShadow: '0 2px 8px rgba(255,255,255,0.3)' }}>
