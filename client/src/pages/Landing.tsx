        ...
        <section className="py-12 md:py-16 relative overflow-hidden bg-[#173c1d]">
          ...
          <div className="container px-4 md:px-6 max-w-6xl mx-auto relative z-10">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-8">
              <div className="flex flex-col items-center">
                <div className="w-36 h-48 md:w-44 md:h-56 rounded-xl overflow-hidden border-4 border-white shadow-xl mb-3">
                  <img 
                    ...
                    alt="Founder" 
                    className="w-full h-full object-cover object-top grayscale scale-90"
                  />
                </div>
              ...
              <div className="flex flex-col items-center">
                <div className="w-36 h-48 md:w-44 md:h-56 rounded-xl bg-gradient-to-br from-[#75C947] to-[#1a4320] flex items-center justify-center border-4 border-white shadow-xl mb-3">
