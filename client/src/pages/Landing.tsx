      ...
      <main>
        ...
        <section className="py-6 bg-white border-y border-gray-100 overflow-hidden">
          <div className="text-center mb-4">
            <span className="text-sm font-medium text-gray-500 uppercase tracking-wider">Works with your favorite platforms</span>
          </div>
          <div className="relative flex overflow-hidden h-12">
            <div className="animate-marquee whitespace-nowrap flex items-center">
              {[...Array(2)].map((_, i) => (
                <div key={i} className="flex items-center gap-12 mx-6">
                  {/* Shopify */}
                  <div className="flex items-center gap-2 opacity-70 hover:opacity-100 transition-opacity">
                    <svg viewBox="0 0 109 40" className="h-8 w-auto" fill="none">
                      <path d="M27.4 8.5c-.1-.6-.6-1-1.1-1-.5 0-4.6-.1-4.6-.1s-3.7-3.5-4.1-3.9c-.4-.4-1.2-.3-1.5-.2 0 0-.8.2-2.1.6-.2-.7-.6-1.6-1.1-2.4-1.6-2.4-3.9-3.7-6.7-3.7h-.3c-.6-.7-1.3-1-1.9-1-4.8 0-7.1 5.9-7.8 8.9-1.8.6-3.1.9-3.3 1-.9.3-1 .3-1.1 1.2C1.6 8.7 0 21.3 0 21.3l20.5 3.8 8.8-2.2c-.1 0-1.8-13.8-1.9-14.4zM15 5.2l-2.7.8c0-1.4-.2-3.5-.8-5.1 2 .4 3 2.6 3.5 4.3zm-4.4 1.3l-5.8 1.8c.6-2.2 1.6-4.4 3.7-5.1.8.2 1.6 1 2.1 2.3v1zm-2.3-6.2c.3 0 .5.1.7.2-2.8 1.3-4.1 4.6-4.8 7.4l-4.5 1.4c1.2-4.2 3.4-9 8.6-9z" fill="#95BF47"/>
                      <path d="M26.3 7.5c-.5 0-4.6-.1-4.6-.1s-3.7-3.5-4.1-3.9c-.1-.1-.3-.2-.5-.2v28.4l8.8-2.2s-1.8-13.8-1.9-14.4c-.1-.5-.6-1-1.1-1-.6.1-2.5-.2-2.5-.2-.1-.6-.4-1-1.1-1l7-.3z" fill="#5E8E3E"/>
                      <path d="M17.2 13.6l-1.9 5.8s-.8-.4-1.9-.4c-1.5 0-1.6.9-1.6 1.2 0 1.3 3.5 1.8 3.5 4.9 0 2.5-1.6 4.1-3.7 4.1-2.5 0-3.8-1.6-3.8-1.6l.7-2.2s1.3 1.1 2.5 1.1c.8 0 1.1-.6 1.1-1.1 0-1.9-2.9-2-2.9-4.6 0-2.4 1.7-4.7 5.2-4.7 1.3-.1 2 .3 2.8.5z" fill="#fff"/>
                      <path d="M40.5 15.9c-1.3-.7-2-1.3-2-2.1 0-1 .9-1.6 2.3-1.6 1.6 0 3.1.7 3.1.7l1.1-3.5s-1.1-.8-4.2-.8c-4.3 0-7.3 2.5-7.3 6 0 2 1.4 3.5 3.3 4.6 1.5.9 2.1 1.5 2.1 2.4 0 1-.8 1.8-2.3 1.8-2.2 0-4.3-1.1-4.3-1.1l-1.2 3.5s1.9 1.3 5.1 1.3c4.5 0 7.7-2.2 7.7-6.2-.2-2.1-1.6-3.7-3.4-5zm18.6-6.4c-2.2 0-3.9 1-5.2 2.6l-.1-.1 1.9-9.9h-5l-4.8 25h5l1.6-8.6c.6-3.3 2.4-5.4 4-5.4 1.2 0 1.6.8 1.6 1.9 0 .7-.1 1.6-.2 2.3l-1.9 9.8h5l1.9-10.1c.2-.9.3-2 .3-2.8.1-2.8-1.4-4.7-4.1-4.7zm14.2 0c-6 0-10 5.4-10 11.5 0 3.9 2.4 7.2 6.9 7.2 5.9 0 9.9-5.3 9.9-11.5 0-3.5-2.1-7.2-6.8-7.2zm-2.3 14.6c-1.7 0-2.4-1.5-2.4-3.3 0-2.9 1.5-7.2 4.3-7.2 1.8 0 2.4 1.5 2.4 3 0 3.2-1.5 7.5-4.3 7.5zm21.5-14.6c-3.3 0-5.2 2.9-5.2 2.9h-.1l.3-2.6h-4.5c-.2 2-.7 5-1.1 7.3l-3.4 17.4h5l1.4-7.1h.1s1 .6 2.8.6c5.9 0 9.7-6 9.7-12.1 0-3.3-1.5-6.4-5-6.4zm-5 14.7c-1.2 0-2-.7-2-.7l.8-4.6c.5-3 2.2-5 4-5 1.5 0 2 1.4 2 2.8 0 3.3-2.1 7.5-4.8 7.5zm15.4-18.5c-1.6 0-2.9 1.3-2.9 2.9 0 1.5 1 2.5 2.4 2.5h.1c1.6 0 2.9-1 2.9-2.9.1-1.5-.9-2.5-2.5-2.5zm-6.3 22.4h5l3.2-16.8h-5.1l-3.1 16.8zm18.7-16.8h-3.5l.2-.8c.3-1.7 1.2-3.3 2.9-3.3.9 0 1.5.2 1.5.2l1-4s-.8-.4-2.5-.4c-1.6 0-3.3.5-4.5 1.5-1.6 1.3-2.3 3.2-2.7 5.1l-.1.7h-2.4l-.7 3.8h2.3l-2.4 13.1h5l2.4-13.1h3.4l1-3.8z" fill="#000"/>
                    </svg>
                  </div>
                  {/* WooCommerce */}
                  <div className="flex items-center gap-2 opacity-70 hover:opacity-100 transition-opacity">
                    <svg viewBox="0 0 168 30" className="h-6 w-auto" fill="none">
                      <path d="M5.6 25.7c-.8 0-1.4-.3-2-.8-.5-.6-.8-1.3-.8-2.2V6.5c0-.9.3-1.6.8-2.2.5-.5 1.2-.8 2-.8h8.3c2.9 0 5.2.8 6.9 2.5 1.6 1.6 2.5 3.9 2.5 6.7v.3c0 2.8-.8 5-2.5 6.7s-4 2.5-6.9 2.5H9v3.5c0 .9-.3 1.6-.8 2.2-.5.5-1.2.8-2 .8h-.6zM9 14.6h4.9c1.2 0 2.2-.4 2.9-1.1.7-.7 1.1-1.7 1.1-3 0-1.3-.4-2.3-1.1-3-.7-.7-1.7-1.1-2.9-1.1H9v8.2z" fill="#9B5C8F"/>
                      <path d="M45.4 25.7c-.7 0-1.3-.2-1.9-.7-.5-.5-.9-1.1-1.1-1.9l-3.1-11.8-3.1 11.8c-.2.8-.6 1.4-1.1 1.9-.5.5-1.1.7-1.9.7s-1.4-.2-1.9-.7c-.5-.5-.9-1.1-1.1-1.9l-4.5-15.5c-.2-.6-.1-1.2.2-1.7.3-.5.8-.8 1.5-.8h1c.7 0 1.3.2 1.8.6.5.4.8 1 1 1.7l2.4 10 3-11.4c.2-.7.5-1.2 1-1.6.5-.4 1-.6 1.7-.6s1.3.2 1.7.6c.5.4.8.9 1 1.6l3 11.4 2.4-10c.2-.7.5-1.3 1-1.7.5-.4 1.1-.6 1.8-.6h1c.7 0 1.2.3 1.5.8.3.5.4 1.1.2 1.7l-4.5 15.5c-.2.8-.6 1.4-1.1 1.9-.5.5-1.2.7-1.9.7z" fill="#9B5C8F"/>
                      <path d="M62.2 26c-2.4 0-4.4-.8-5.9-2.3-1.5-1.5-2.3-3.6-2.3-6.1v-1.6c0-2.6.8-4.6 2.3-6.1 1.5-1.5 3.5-2.3 5.9-2.3s4.4.8 5.9 2.3c1.5 1.5 2.3 3.6 2.3 6.1v1.6c0 2.6-.8 4.6-2.3 6.1-1.5 1.5-3.5 2.3-5.9 2.3zm0-4.4c1 0 1.8-.3 2.4-1 .6-.7.9-1.6.9-2.8v-1.6c0-1.2-.3-2.2-.9-2.8-.6-.7-1.4-1-2.4-1s-1.8.3-2.4 1c-.6.7-.9 1.6-.9 2.8v1.6c0 1.2.3 2.2.9 2.8.6.7 1.4 1 2.4 1z" fill="#9B5C8F"/>
                      <path d="M80.9 26c-2.4 0-4.4-.8-5.9-2.3-1.5-1.5-2.3-3.6-2.3-6.1v-1.6c0-2.6.8-4.6 2.3-6.1 1.5-1.5 3.5-2.3 5.9-2.3s4.4.8 5.9 2.3c1.5 1.5 2.3 3.6 2.3 6.1v1.6c0 2.6-.8 4.6-2.3 6.1-1.5 1.5-3.5 2.3-5.9 2.3zm0-4.4c1 0 1.8-.3 2.4-1 .6-.7.9-1.6.9-2.8v-1.6c0-1.2-.3-2.2-.9-2.8-.6-.7-1.4-1-2.4-1s-1.8.3-2.4 1c-.6.7-.9 1.6-.9 2.8v1.6c0 1.2.3 2.2.9 2.8.6.7 1.4 1 2.4 1z" fill="#9B5C8F"/>
                      <path d="M100.3 26c-2.5 0-4.6-.8-6.2-2.4-1.6-1.6-2.4-3.6-2.4-6v-1.4c0-2.4.8-4.5 2.4-6.1 1.6-1.6 3.7-2.4 6.2-2.4 2.3 0 4.2.6 5.6 1.9 1.4 1.3 2.2 3 2.4 5.2 0 .5-.1.9-.4 1.2-.3.3-.7.5-1.2.5h-.9c-.6 0-1.1-.2-1.5-.5-.4-.3-.6-.8-.7-1.4-.2-1-.5-1.7-1.1-2.1-.5-.4-1.3-.6-2.2-.6-1.1 0-2 .4-2.6 1.1-.6.7-1 1.7-1 2.9v1.4c0 1.2.3 2.2 1 2.9.6.7 1.5 1.1 2.6 1.1.9 0 1.7-.2 2.2-.6.5-.4.9-1.1 1.1-2.1.1-.6.3-1.1.7-1.4.4-.3.9-.5 1.5-.5h.9c.5 0 .9.2 1.2.5.3.3.4.7.4 1.2-.2 2.2-1 4-2.4 5.2-1.4 1.3-3.3 2-5.6 2z" fill="#9B5C8F"/>
                      <path d="M117.6 26c-2.4 0-4.4-.8-5.9-2.3-1.5-1.5-2.3-3.6-2.3-6.1v-1.6c0-2.6.8-4.6 2.3-6.1 1.5-1.5 3.5-2.3 5.9-2.3s4.4.8 5.9 2.3c1.5 1.5 2.3 3.6 2.3 6.1v1.6c0 2.6-.8 4.6-2.3 6.1-1.5 1.5-3.5 2.3-5.9 2.3zm0-4.4c1 0 1.8-.3 2.4-1 .6-.7.9-1.6.9-2.8v-1.6c0-1.2-.3-2.2-.9-2.8-.6-.7-1.4-1-2.4-1s-1.8.3-2.4 1c-.6.7-.9 1.6-.9 2.8v1.6c0 1.2.3 2.2.9 2.8.6.7 1.4 1 2.4 1z" fill="#9B5C8F"/>
                      <path d="M127.8 25.7c-.7 0-1.2-.2-1.6-.6-.4-.4-.6-.9-.6-1.6V10c0-.7.2-1.2.6-1.6.4-.4.9-.6 1.6-.6h.7c.6 0 1.1.1 1.5.4.4.3.7.6.9 1.1l.3.9c.6-.8 1.4-1.4 2.3-1.9.9-.5 2-.7 3.2-.7.7 0 1.2.2 1.6.6.4.4.6.9.6 1.6v.4c0 .7-.2 1.2-.6 1.6-.4.4-.9.6-1.6.6-1.3 0-2.3.4-3 1.1-.7.7-1.1 1.7-1.1 3v6.9c0 .7-.2 1.2-.6 1.6-.4.4-.9.6-1.6.6h-.6z" fill="#9B5C8F"/>
                      <path d="M147.4 26c-2.4 0-4.4-.7-5.9-2.2-1.5-1.5-2.2-3.5-2.2-6v-1.5c0-2.6.7-4.6 2.2-6.1 1.5-1.5 3.4-2.2 5.7-2.2 2.3 0 4.1.7 5.4 2.1 1.3 1.4 2 3.3 2 5.7v1.2c0 .6-.2 1.1-.5 1.4-.3.3-.8.5-1.4.5h-8.8c.1.9.4 1.6 1 2.1.6.5 1.4.8 2.4.8.7 0 1.4-.1 1.9-.3.5-.2 1-.5 1.4-.9.4-.3.8-.5 1.3-.5h.8c.5 0 .9.2 1.2.5.3.3.4.7.3 1.2-.1.5-.3 1-.7 1.5-.8 1-1.8 1.7-3 2.2-1.2.4-2.5.6-3.9.6zm-3.5-11h6.5c0-1-.3-1.8-.9-2.4-.6-.6-1.4-.9-2.4-.9s-1.8.3-2.4.9c-.5.6-.8 1.4-.8 2.4z" fill="#9B5C8F"/>
                      <path d="M161.1 26c-.7 0-1.2-.2-1.6-.6-.4-.4-.6-.9-.6-1.6V10c0-.7.2-1.2.6-1.6.4-.4.9-.6 1.6-.6h.7c.6 0 1.1.1 1.5.4.4.3.7.6.9 1.1l.3.9c.6-.8 1.4-1.4 2.3-1.9.9-.5 2-.7 3.2-.7.7 0 1.2.2 1.6.6.4.4.6.9.6 1.6v.4c0 .7-.2 1.2-.6 1.6-.4.4-.9.6-1.6.6-1.3 0-2.3.4-3 1.1-.7.7-1.1 1.7-1.1 3v6.9c0 .7-.2 1.2-.6 1.6-.4.4-.9.6-1.6.6h-.6z" fill="#9B5C8F"/>
                    </svg>
                  </div>
                  {/* WordPress */}
                  <div className="flex items-center gap-2 opacity-70 hover:opacity-100 transition-opacity">
                    <svg viewBox="0 0 122 30" className="h-6 w-auto" fill="none">
                      <path d="M5.9 6.4c3.3 0 5.9 2.6 5.9 5.9s-2.6 5.9-5.9 5.9S0 15.6 0 12.3s2.6-5.9 5.9-5.9zm0 11c2.8 0 5.1-2.3 5.1-5.1S8.7 7.2 5.9 7.2.8 9.5.8 12.3s2.3 5.1 5.1 5.1z" fill="#21759B"/>
                      <path d="M1 12.3c0-2.7 2.2-4.9 4.9-4.9 1.3 0 2.4.5 3.3 1.3L5.9 17.2c-2.7 0-4.9-2.2-4.9-4.9z" fill="#21759B"/>
                      <path d="M5.9 7.4c1.2 0 2.3.4 3.1 1.2L5.9 17c-2.6 0-4.7-2.1-4.7-4.7 0-2.7 2.1-4.9 4.7-4.9z" fill="#21759B"/>
                      <path d="M6 7.6l3 9.3c1.5-.7 2.5-2.2 2.5-4 0-2.4-2-4.4-4.4-4.4-.4 0-.7 0-1.1.1z" fill="#21759B"/>
                      <path d="M24.4 18.4l-2.6-8.8h-2.1l-2.6 8.8-2.4-8.8h-2.3l3.5 12h2.2l2.6-8.8 2.6 8.8h2.2l3.5-12h-2.2l-2.4 8.8z" fill="#21759B"/>
                      <path d="M32.2 15.8c0-2.8 2-5.1 5-5.1s5 2.3 5 5.1-2 5.1-5 5.1-5-2.3-5-5.1zm8 0c0-1.7-1.1-3.2-3-3.2s-3 1.5-3 3.2 1.1 3.2 3 3.2 3-1.5 3-3.2z" fill="#21759B"/>
                      <path d="M44.9 20.9V11h1.5c.6 0 1 .4 1 1v.4c.5-.9 1.5-1.6 2.9-1.6v2.2c-1.6 0-2.8.8-2.8 2.8v5.1h-2.6z" fill="#21759B"/>
                      <path d="M60.4 6.4h2.6v14.5h-1.5c-.6 0-1-.4-1-1v-.3c-.6.9-1.7 1.5-3.2 1.5-2.7 0-4.5-2.1-4.5-5.1s1.8-5.1 4.5-5.1c1.4 0 2.5.5 3.1 1.4V6.4zm-2.7 12.6c1.7 0 2.8-1.3 2.8-3.1s-1.1-3.1-2.8-3.1-2.8 1.3-2.8 3.1 1.1 3.1 2.8 3.1z" fill="#21759B"/>
                      <path d="M66.8 20.9V6.4h2.6v14.5h-2.6z" fill="#21759B"/>
                      <path d="M80.3 6.4c4.5 0 7.5 3.2 7.5 7.2s-3 7.2-7.5 7.2h-5.9V6.4h5.9zm-.1 12.5c3 0 4.8-2.2 4.8-5.3s-1.8-5.3-4.8-5.3h-3v10.6h3z" fill="#21759B"/>
                      <path d="M90.8 20.9V11h1.5c.6 0 1 .4 1 1v.4c.5-.9 1.5-1.6 2.9-1.6v2.2c-1.6 0-2.8.8-2.8 2.8v5.1h-2.6z" fill="#21759B"/>
                      <path d="M99.1 15.9c0-3 2.1-5.2 5.1-5.2 3 0 5.1 2.1 5.1 5v.8h-8c.2 1.5 1.4 2.5 3 2.5 1.1 0 2-.4 2.6-1.1l1.4 1.3c-.9 1.1-2.4 1.8-4.1 1.8-3.1 0-5.1-2.2-5.1-5.1zm5.1-3.4c-1.5 0-2.5 1-2.7 2.3h5.4c-.2-1.4-1.2-2.3-2.7-2.3z" fill="#21759B"/>
                      <path d="M111.7 19.8l1.4-1.5c.7.8 1.8 1.3 2.9 1.3 1 0 1.6-.4 1.6-1s-.5-.8-1.5-1l-1.1-.2c-1.8-.4-2.9-1.2-2.9-2.8 0-1.8 1.6-3.1 3.9-3.1 1.6 0 2.9.5 3.9 1.5l-1.3 1.5c-.7-.7-1.6-1.1-2.6-1.1-.9 0-1.4.4-1.4.9s.4.8 1.4 1l1.1.2c1.9.4 3 1.3 3 2.9 0 1.9-1.6 3.2-4.1 3.2-1.8-.1-3.3-.7-4.3-1.8z" fill="#21759B"/>
                      <path d="M122 19.8l1.4-1.5c.7.8 1.8 1.3 2.9 1.3 1 0 1.6-.4 1.6-1s-.5-.8-1.5-1l-1.1-.2c-1.8-.4-2.9-1.2-2.9-2.8 0-1.8 1.6-3.1 3.9-3.1 1.6 0 2.9.5 3.9 1.5l-1.3 1.5c-.7-.7-1.6-1.1-2.6-1.1-.9 0-1.4.4-1.4.9s.4.8 1.4 1l1.1.2c1.9.4 3 1.3 3 2.9 0 1.9-1.6 3.2-4.1 3.2-1.8-.1-3.3-.7-4.3-1.8z" fill="#21759B"/>
                    </svg>
                  </div>
                  {/* Wix */}
                  <div className="flex items-center gap-2 opacity-70 hover:opacity-100 transition-opacity">
                    <svg viewBox="0 0 60 24" className="h-6 w-auto" fill="none">
                      <path d="M14.8 4c-.8.3-1.3.8-1.6 1.3-.5-.7-1.3-1.2-2.5-1.3-.3 0-.6 0-.9.1-.5.1-.9.3-1.3.6V4.5c0-.2-.2-.4-.4-.4H6.6c-.2 0-.4.2-.4.4v14.9c0 .2.2.4.4.4h1.8c.2 0 .4-.2.4-.4v-8c0-.5.1-1 .3-1.4.2-.4.5-.8.9-1 .4-.2.8-.4 1.3-.4.7 0 1.2.2 1.5.6.3.4.5 1 .5 1.8v8.4c0 .2.2.4.4.4h1.8c.2 0 .4-.2.4-.4v-8c0-.5.1-1 .3-1.4.2-.4.5-.8.9-1 .4-.2.8-.4 1.3-.4.7 0 1.2.2 1.5.6.3.4.5 1 .5 1.8v8.4c0 .2.2.4.4.4h1.8c.2 0 .4-.2.4-.4V10c0-.9-.2-1.7-.5-2.4-.3-.7-.8-1.2-1.4-1.5-.6-.3-1.4-.5-2.2-.5-.8 0-1.6.2-2.3.6l.1-.2z" fill="#000"/>
                      <path d="M34.4 4.1H32c-.3 0-.5.2-.6.4L28 14.1l-3.4-9.6c-.1-.3-.3-.4-.6-.4h-2.4c-.3 0-.5.3-.4.6l5 13.8c.1.2.3.4.6.4h2.1c.3 0 .5-.2.6-.4l5-13.8c.1-.3-.1-.6-.5-.6z" fill="#000"/>
                      <path d="M38.2 4.1h-2c-.2 0-.4.2-.4.4v14.9c0 .2.2.4.4.4h2c.2 0 .4-.2.4-.4V4.5c0-.2-.2-.4-.4-.4z" fill="#000"/>
                      <path d="M54.1 4.1h-2.4c-.3 0-.5.2-.6.4L48 13.6l-3.1-9.1c-.1-.3-.3-.4-.6-.4h-2.4c-.3 0-.5.3-.4.6l4.6 12.8-2.4 6c-.1.3.1.6.4.6h2.3c.3 0 .5-.2.6-.4l7-18.9c.2-.4 0-.7-.4-.7z" fill="#FAAD4D"/>
                    </svg>
                  </div>
                  {/* Squarespace */}
                  <div className="flex items-center gap-2 opacity-70 hover:opacity-100 transition-opacity">
                    <svg viewBox="0 0 130 24" className="h-5 w-auto" fill="none">
                      <path d="M6.3 8.5l4.8-4.8c.8-.8 2.2-.8 3 0l9.5 9.5c.8.8.8 2.2 0 3l-4.8 4.8c-.8.8-2.2.8-3 0L6.3 11.5c-.8-.8-.8-2.2 0-3z" fill="#000"/>
                      <path d="M11.1 3.7l4.8-4.8c.8-.8 2.2-.8 3 0l9.5 9.5c.8.8.8 2.2 0 3l-4.8 4.8c-.8.8-2.2.8-3 0L11.1 6.7c-.8-.8-.8-2.2 0-3z" fill="#000"/>
                      <path d="M1.5 13.3l4.8-4.8c.8-.8 2.2-.8 3 0l9.5 9.5c.8.8.8 2.2 0 3l-4.8 4.8c-.8.8-2.2.8-3 0l-9.5-9.5c-.8-.8-.8-2.2 0-3z" fill="#000"/>
                      <path d="M41.1 15.5c-1.3.8-2.7 1.2-4.2 1.2-1.8 0-3.4-.6-4.6-1.7s-1.9-2.6-1.9-4.4c0-1.9.6-3.4 1.9-4.5s2.8-1.7 4.7-1.7c1.5 0 2.8.3 4.1 1l-.9 1.9c-1-.5-2-.8-3.1-.8-1.2 0-2.1.4-2.9 1.1-.7.7-1.1 1.7-1.1 2.9s.4 2.2 1.1 2.9c.8.7 1.7 1.1 2.8 1.1 1.2 0 2.3-.4 3.3-1.1l.8 2.1z" fill="#000"/>
                      <path d="M53.4 10.6c0 .5-.1 1-.2 1.5H45c.2 1.9 1.4 2.9 3.4 2.9 1.2 0 2.2-.4 3.1-1.1l1 1.6c-1.2 1-2.7 1.5-4.4 1.5-1.9 0-3.4-.6-4.5-1.7-1.1-1.1-1.7-2.6-1.7-4.4 0-1.8.6-3.3 1.7-4.5 1.1-1.2 2.6-1.8 4.4-1.8 1.7 0 3.1.6 4.1 1.7 1 1.1 1.5 2.5 1.3 4.3zm-8.4-.7h5.9c-.1-.9-.4-1.6-.9-2.1s-1.2-.8-2-.8c-.9 0-1.6.3-2.1.8-.6.5-.8 1.2-.9 2.1z" fill="#000"/>
                      <path d="M55.5 19.7V4.8h2.3l.1 1.3c.9-1 2.1-1.6 3.6-1.6s2.7.6 3.5 1.7c.9 1.2 1.3 2.7 1.3 4.5 0 1.8-.4 3.3-1.3 4.5-.9 1.2-2.1 1.7-3.6 1.7-1.4 0-2.5-.5-3.3-1.4v4.2h-2.6zm5.4-5.3c.9 0 1.6-.4 2.1-1.1.5-.7.8-1.7.8-2.9s-.3-2.2-.8-2.9c-.5-.7-1.2-1.1-2.1-1.1-.9 0-1.7.4-2.2 1.1-.6.7-.8 1.7-.8 2.9s.3 2.2.8 2.9c.5.8 1.3 1.1 2.2 1.1z" fill="#000"/>
                      <path d="M77.9 16.4h-2.3l-.1-1.1c-.8.9-1.9 1.4-3.2 1.4-1.1 0-2-.3-2.6-.9-.7-.6-1-1.4-1-2.4 0-1.1.5-2 1.4-2.6.9-.6 2.2-.9 3.9-.9h1.4v-.5c0-.6-.2-1.1-.5-1.4-.4-.3-.9-.5-1.6-.5-.9 0-1.9.3-2.9.8l-.8-1.7c1.3-.7 2.7-1 4.1-1 1.4 0 2.5.4 3.2 1.1.7.7 1.1 1.8 1.1 3.1v6.6zm-2.6-4.5h-1.2c-2 0-2.9.6-2.9 1.7 0 .5.2.9.5 1.1.3.3.8.4 1.3.4.7 0 1.2-.2 1.7-.6.5-.4.7-.9.7-1.6v-1z" fill="#000"/>
                      <path d="M88.6 15.5c-1.3.8-2.7 1.2-4.2 1.2-1.8 0-3.4-.6-4.6-1.7s-1.9-2.6-1.9-4.4c0-1.9.6-3.4 1.9-4.5s2.8-1.7 4.7-1.7c1.5 0 2.8.3 4.1 1l-.9 1.9c-1-.5-2-.8-3.1-.8-1.2 0-2.1.4-2.9 1.1-.7.7-1.1 1.7-1.1 2.9s.4 2.2 1.1 2.9c.8.7 1.7 1.1 2.8 1.1 1.2 0 2.3-.4 3.3-1.1l.8 2.1z" fill="#000"/>
                      <path d="M100.9 10.6c0 .5-.1 1-.2 1.5h-8.2c.2 1.9 1.4 2.9 3.4 2.9 1.2 0 2.2-.4 3.1-1.1l1 1.6c-1.2 1-2.7 1.5-4.4 1.5-1.9 0-3.4-.6-4.5-1.7-1.1-1.1-1.7-2.6-1.7-4.4 0-1.8.6-3.3 1.7-4.5 1.1-1.2 2.6-1.8 4.4-1.8 1.7 0 3.1.6 4.1 1.7 1 1.1 1.4 2.5 1.3 4.3zm-8.4-.7h5.9c-.1-.9-.4-1.6-.9-2.1s-1.2-.8-2-.8c-.9 0-1.6.3-2.1.8-.6.5-.8 1.2-.9 2.1z" fill="#000"/>
                    </svg>
                  </div>
                  {/* BigCommerce */}
                  <div className="flex items-center gap-2 opacity-70 hover:opacity-100 transition-opacity">
                    <svg viewBox="0 0 140 24" className="h-5 w-auto" fill="none">
                      <path d="M12.7 4.5H5.3C2.4 4.5 0 6.9 0 9.8v4.4c0 2.9 2.4 5.3 5.3 5.3h7.4c2.9 0 5.3-2.4 5.3-5.3V9.8c0-2.9-2.4-5.3-5.3-5.3zm2.1 9.2h-4.3v2.9H7.5v-2.9H3.2v-3h4.3V7.8h3v2.9h4.3v3z" fill="#34313F"/>
                      <path d="M27 7.9v2.7h4.2c.2 0 .4.1.6.2.1.1.2.3.2.5v.5c0 .2-.1.4-.2.5-.1.1-.4.2-.6.2H27v2.7h4.6c.2 0 .4.1.6.2.1.1.2.3.2.5v.6c0 .2-.1.4-.2.5-.1.1-.4.2-.6.2h-6.2c-.3 0-.5-.1-.7-.3-.2-.2-.3-.4-.3-.7V5.7c0-.3.1-.5.3-.7.2-.2.4-.3.7-.3h6.2c.2 0 .4.1.6.2.1.1.2.3.2.5v.6c0 .2-.1.4-.2.5-.1.1-.4.2-.6.2H27v1.2z" fill="#34313F"/>
                      <path d="M38 4.7c.3 0 .5.1.7.3.2.2.3.4.3.7v9.6c0 .3-.1.5-.3.7-.2.2-.4.3-.7.3h-1.2c-.3 0-.5-.1-.7-.3-.2-.2-.3-.4-.3-.7V5.7c0-.3.1-.5.3-.7.2-.2.4-.3.7-.3H38z" fill="#34313F"/>
                      <path d="M50.5 11.4v.2c0 .4-.3.7-.7.7h-5.4c.1.7.4 1.3.9 1.7.5.4 1.1.6 1.8.6.5 0 1-.1 1.4-.3.4-.2.8-.5 1.1-.9.2-.2.4-.3.7-.3h1.2c.2 0 .4.1.5.2.1.1.2.3.1.5-.2.7-.5 1.3-1 1.8-.5.5-1.1.9-1.8 1.2-.7.3-1.5.4-2.3.4-1 0-1.9-.2-2.7-.7-.8-.4-1.4-1-1.8-1.8-.4-.8-.7-1.7-.7-2.8 0-1.1.2-2 .7-2.8.4-.8 1-1.4 1.8-1.8.8-.4 1.7-.7 2.7-.7s1.9.2 2.7.6c.8.4 1.3 1 1.8 1.7.3.8.5 1.6.5 2.5zm-5.3-2c-.6 0-1.2.2-1.6.5-.4.4-.7.9-.8 1.5h4.8c-.1-.6-.4-1.1-.8-1.5-.4-.3-.9-.5-1.6-.5z" fill="#34313F"/>
                      <path d="M61.9 12.9c0 .9-.2 1.6-.5 2.2-.3.6-.8 1.1-1.4 1.4-.6.3-1.3.5-2.1.5-1.1 0-2-.3-2.7-.9v2.6c0 .3-.1.5-.3.7-.2.2-.4.3-.7.3h-1.2c-.3 0-.5-.1-.7-.3-.2-.2-.3-.4-.3-.7V8.2c0-.3.1-.5.3-.7.2-.2.4-.3.7-.3h1.2c.3 0 .5.1.7.3.2.2.3.4.3.7v.4c.7-.8 1.7-1.2 3-1.2.8 0 1.5.2 2.1.5.6.3 1.1.8 1.4 1.4.3.6.5 1.4.5 2.3v.3zm-2.5-.3c0-.7-.2-1.3-.5-1.7-.3-.4-.8-.6-1.4-.6-.7 0-1.3.2-1.6.7-.4.5-.5 1.1-.5 1.9 0 .7.2 1.3.5 1.7.4.4.9.6 1.5.6s1.1-.2 1.4-.6c.4-.4.6-1 .6-1.7v-.3z" fill="#34313F"/>
                      <path d="M72.7 12.9c0 .9-.2 1.6-.5 2.2-.3.6-.8 1.1-1.4 1.4-.6.3-1.3.5-2.1.5-1.1 0-2-.3-2.7-.9v2.6c0 .3-.1.5-.3.7-.2.2-.4.3-.7.3h-1.2c-.3 0-.5-.1-.7-.3-.2-.2-.3-.4-.3-.7V8.2c0-.3.1-.5.3-.7.2-.2.4-.3.7-.3H65c.3 0 .5.1.7.3.2.2.3.4.3.7v.4c.7-.8 1.7-1.2 3-1.2.8 0 1.5.2 2.1.5.6.3 1.1.8 1.4 1.4.3.6.5 1.4.5 2.3v.3zm-2.5-.3c0-.7-.2-1.3-.5-1.7-.3-.4-.8-.6-1.4-.6-.7 0-1.3.2-1.6.7-.4.5-.5 1.1-.5 1.9 0 .7.2 1.3.5 1.7.4.4.9.6 1.5.6s1.1-.2 1.4-.6c.4-.4.6-1 .6-1.7v-.3z" fill="#34313F"/>
                    </svg>
                  </div>
                  {/* Magento */}
                  <div className="flex items-center gap-2 opacity-70 hover:opacity-100 transition-opacity">
                    <svg viewBox="0 0 100 24" className="h-6 w-auto" fill="none">
                      <path d="M14 4l-7 4v12l3.5 2V10l3.5-2 3.5 2v12l3.5-2V8l-7-4z" fill="#F26322"/>
                      <path d="M32.4 16.4V9.8l-2.9 5.1h-1.1l-2.9-5.1v6.6h-1.9V7.2h2.2l2.7 4.7 2.7-4.7h2.2v9.2h-2z" fill="#000"/>
                      <path d="M42.4 16.4l-.7-1.8h-4.1l-.7 1.8h-2.2l3.8-9.2h2.3l3.8 9.2h-2.2zm-2.8-7.1l-1.5 3.8h3l-1.5-3.8z" fill="#000"/>
                      <path d="M53.6 14.8v1.6h-7.1V7.2h6.9v1.6h-4.9v2.2h4.3v1.6h-4.3v2.2h5.1z" fill="#000"/>
                      <path d="M62.4 7.2h2v9.2h-1.8l-4.4-5.9v5.9h-2V7.2h1.8l4.4 5.9V7.2z" fill="#000"/>
                      <path d="M73.2 8.8h-2.8v7.6h-2V8.8h-2.8V7.2h7.6v1.6z" fill="#000"/>
                      <path d="M81.8 12c0 2.7-2.1 4.6-4.8 4.6-2.7 0-4.8-1.9-4.8-4.6s2.1-4.6 4.8-4.6c2.7 0 4.8 1.9 4.8 4.6zm-7.5 0c0 1.7 1.2 3 2.8 3s2.8-1.3 2.8-3-1.2-3-2.8-3-2.8 1.3-2.8 3z" fill="#000"/>
                    </svg>
                  </div>
                  {/* Custom Integration */}
                  <div className="flex items-center gap-2 opacity-70 hover:opacity-100 transition-opacity">
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-gray-100 rounded-full">
                      ...
                      <span className="text-sm font-medium text-gray-700">Custom Integration</span>
                    </div>
                  </div>
                </div>
              ))}
