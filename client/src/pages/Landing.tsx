...
function HorizontalScrollText() {
  ...
  return (
    <section 
      ref={sectionRef}
      className="py-12 md:py-16 overflow-hidden relative bg-[#e7f8d0]"
    >
      <div className="text-center mb-4">
        <p className="text-xs md:text-sm font-semibold text-[#1a4320]/80 uppercase tracking-[0.2em]">
          A BETTER WAY TO PAY
        </p>
      </div>
      <div className="relative">
        ...
        >
          {[...Array(4)].map((_, i) => (
            <span 
              key={i}
              className="text-5xl md:text-7xl lg:text-8xl font-bold text-[#1a4320]/30 mx-4"
...
function TestimonialsCarousel() {
  ...
  return (
    <section className="py-10 md:py-14 relative bg-white">
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <section className="py-16 md:py-24 relative overflow-hidden bg-[#74747c]">
          <div 
          ...
          <div className="container px-4 md:px-6 max-w-7xl mx-auto relative z-10">
            ...
            <div className="flex flex-col lg:flex-row gap-4 min-h-[500px]">
              <div 
                className="group relative flex-1 rounded-3xl p-8 md:p-10 overflow-hidden cursor-pointer transition-all duration-500 hover:flex-[2] lg:hover:flex-[2] bg-[#383838]"
        ...
        <section className="py-20 md:py-32 relative overflow-hidden bg-[#f9fafb]">
        ...
        <section className="py-20 md:py-32 overflow-hidden relative bg-[#ffffff]">
          ...
          <div className="container px-4 md:px-6 max-w-7xl mx-auto relative z-10">
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
              ...
              <div className="lg:w-1/2 space-y-6 order-1 lg:order-1 text-center flex flex-col items-center">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900">
        ...
        {/* Payouts Section */}
        <section className="py-20 md:py-32 relative overflow-hidden bg-[#fbfcfb]">
          <div className="absolute top-1/2 right-0 w-72 h-72 rounded-full bg-gradient-to-l from-lime-300/10 to-[#75C947]/5 blur-3xl translate-x-1/2" />
          <div className="absolute bottom-0 left-1/4 w-64 h-64 rounded-full bg-gradient-to-t from-emerald-300/8 to-[#75C947]/5 blur-3xl translate-y-1/2" />
          <div className="container px-4 md:px-6 max-w-7xl mx-auto relative z-10">
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        ...
        <section className="py-12 md:py-16 relative overflow-hidden">
          <div 
            ...
            style={{ backgroundImage: `url('/attached_assets/ChatGPT_Image_Dec_29,_2025,_05_19_21_PM_1767070019676.png')` }}
          />
          <div className="container px-4 md:px-6 max-w-6xl mx-auto relative z-10">
            <div className="text-center mb-8 md:mb-10">
              <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-3" style={{ textShadow: '0 2px 4px rgba(0,0,0,0.2)' }}>
                Your success is our business
              </h3>
              <p className="text-base md:text-lg text-white/90 max-w-4xl mx-auto" style={{ textShadow: '0 1px 2px rgba(0,0,0,0.15)' }}>
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-8">
              <div className="flex flex-col items-center">
                ...
                <h4 className="text-lg font-bold text-white" style={{ textShadow: '0 1px 2px rgba(0,0,0,0.2)' }}>Marty</h4>
              ...
              <div className="flex flex-col items-center">
                ...
                <h4 className="text-lg font-bold text-white" style={{ textShadow: '0 1px 2px rgba(0,0,0,0.2)' }}>Patricia</h4>
              ...
              <div className="flex flex-col items-center">
                ...
                <h4 className="text-lg font-bold text-white" style={{ textShadow: '0 1px 2px rgba(0,0,0,0.2)' }}>Kat</h4>
                <p className="text-white/80 text-sm">Accounting</p>
              </div>
              <div className="flex flex-col items-center">
                <div className="mb-3">
                  <div className="w-36 h-48 md:w-44 md:h-56 rounded-xl overflow-hidden border-4 border-white shadow-xl">
                ...
                <h4 className="text-lg font-bold text-white" style={{ textShadow: '0 1px 2px rgba(0,0,0,0.2)' }}>Darth Maul</h4>
              ...
              <div className="flex flex-col items-center">
                ...
                <h4 className="text-lg font-bold text-white" style={{ textShadow: '0 1px 2px rgba(0,0,0,0.2)' }}>Oink</h4>
                <p className="text-white/80 text-sm">AI Team Lead</p>
              </div>
            </div>
          </div>
        </section>
