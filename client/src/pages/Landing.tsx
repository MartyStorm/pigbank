...
function HorizontalScrollText() {
  ...
  return (
    <section 
      ref={sectionRef}
      className="py-12 md:py-16 overflow-hidden relative bg-[#e5e7ec]"
    >
      <div className="text-center mb-4">
        <p className="text-xs md:text-sm font-semibold text-gray-600 uppercase tracking-[0.2em]">
          A BETTER WAY TO PAY
        </p>
      </div>
      <div className="relative">
        ...
        >
          {[...Array(4)].map((_, i) => (
            <span 
              key={i}
              className="text-5xl md:text-7xl lg:text-8xl font-bold text-gray-400/50 mx-4"
