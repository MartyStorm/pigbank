          ...
          <div className="container px-4 md:px-6 max-w-6xl mx-auto relative z-10">
            <div className="text-center mb-8 md:mb-10">
              ...
              <p className="text-base md:text-lg text-white/70 max-w-4xl mx-auto">
                We're a focused team that actually knows your business. Fast responses, personal service, and Oink—a custom AI built from scratch by PigBank, trained on our ecosystem and ready to help 24/7.
              </p>
            </div>
