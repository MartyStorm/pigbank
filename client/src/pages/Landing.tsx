      ...
      <div className="relative">
        ...
        >
          {[...Array(4)].map((_, i) => (
            <span 
              key={i}
              className="text-5xl md:text-7xl lg:text-8xl font-bold mx-4 text-[#72cb43]"
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
            ...
            >
              <div className="flex flex-col items-center text-center gap-6">
                <div className="space-y-4">
                  <h1 className="hero-title font-bold tracking-tight text-white" style={{ textShadow: '0 2px 12px rgba(0,0,0,0.3)' }}>
                    Built for Business, Payment Processing
                  </h1>
                  <p className="text-xl md:text-2xl text-white font-semibold" style={{ textShadow: '0 2px 12px rgba(0,0,0,0.3)' }}>
        ...
        <section className="py-8 bg-[#363636]">
              ...
              <div className="lg:w-1/2">
                <div className="relative inline-flex items-center justify-center">
                  <img 
                    ...
                    className="absolute left-[-85px] md:left-[-115px] lg:left-[-135px] xl:left-[-155px] bottom-[-30px] w-[100px] md:w-[130px] lg:w-[155px] xl:w-[175px] h-auto z-10"
                  />
              ...
              <div className="lg:w-1/2 flex justify-center">
                <div className="relative inline-flex items-center justify-center">
                  <img 
                    ...
                    className="absolute left-[-85px] md:left-[-115px] lg:left-[-135px] xl:left-[-155px] bottom-[-20px] w-[120px] md:w-[150px] lg:w-[180px] xl:w-[200px] h-auto z-10"
                  />
                  <div className="w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden bg-[#2f8a2b] flex items-center justify-center">
        ...
        <section 
          className="py-12 md:py-20 relative overflow-hidden bg-[#e8f5e0]"
        >
          <div className="container px-4 md:px-6 max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-8 md:mb-10">
