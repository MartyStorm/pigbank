      ...
      <div className="relative">
        ...
        >
          {[...Array(4)].map((_, i) => (
            <span 
              key={i}
              className="text-5xl md:text-7xl lg:text-8xl font-bold mx-4 text-[#c4cbc3]"
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
                    ...
                    <div className="flex flex-col gap-4 animate-scroll-up">
                      ...
                      <div className="w-24 h-24 md:w-28 md:h-28 bg-white rounded-2xl shadow-sm flex items-center justify-center border border-gray-100">
                        <svg viewBox="0 0 40 40" className="w-12 h-8">
                          ...
                          <path d="M22 17.5v-1c0-.2.1-.3.3-.3h5.4c.2 0 .3.1.3.3v.9c0 .2-.1.4-.4.7l-2.8 4c1 0 2.1.1 3 .6.2.1.3.3.3.5v1.1c0 .2-.2.4-.4.3-1.8-.9-4.2-1-6.2 0-.2.1-.4-.1-.4-.3v-1c0-.2 0-.5.2-.7l3.3-4.7h-2.9c-.2 0-.3-.1-.3-.3" fill="#333" transform="translate(0 -2) scale(0.9)"/>
                        </svg>
                      </div>
                    ...
                    <div className="flex flex-col gap-4 animate-scroll-up">
                      ...
                      <div className="w-24 h-24 md:w-28 md:h-28 bg-white rounded-2xl shadow-sm flex items-center justify-center border border-gray-100">
                        <svg viewBox="0 0 50 24" className="w-12 h-8">
                          ...
                          <path d="M43.5 9.7l-4.5 10.4h-1.4l1.7-3.6-3-6.8h1.5l2.1 5.1h.1l2.1-5.1h1.4z" fill="#5f6368"/>
                          <path d="M15.5 11.3c0-.4 0-.8-.1-1.2h-6.2v2.2h3.5c-.1.8-.5 1.5-1.2 2v1.6h1.9c1.1-1 1.8-2.6 2.1-4.6z" fill="#4285f4"/>
                          <path d="M9.2 16.8c1.7 0 3.1-.5 4.1-1.5l-1.9-1.6c-.6.4-1.3.6-2.2.6-1.7 0-3.1-1.1-3.6-2.7H3.5v1.6c1.1 2.1 3.2 3.6 5.7 3.6z" fill="#34a853"/>
                          <path d="M5.6 11.6c-.1-.4-.2-.8-.2-1.3s.1-.9.2-1.3V7.4H3.5c-.5 1-.7 2-.7 3.2s.3 2.2.7 3.2l2.1-1.6z" fill="#fbbc04"/>
        ...
        <section className="py-16 md:py-24 bg-[#1a4320]">
          <div className="container px-4 md:px-6 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row gap-4 lg:min-h-[520px]">
              ...
              {/* High Risk Card */}
              <div 
                className="group relative flex-1 rounded-3xl p-8 md:p-10 overflow-hidden lg:cursor-pointer transition-all duration-500 lg:hover:flex-[1.5] bg-[#70c244]"
        ...
        <section 
          className="py-12 md:py-20 relative overflow-hidden bg-[#e3f9b5]"
        >
          <div 
            className="absolute inset-0"
            style={{
              backgroundImage: `url('/attached_assets/ChatGPT_Image_Dec_29,_2025,_05_19_21_PM_1767527196918.png')`,
              backgroundSize: 'cover',
              backgroundPosition: 'center bottom'
            }}
          />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                ...
                <li><a href="#" className="hover:text-white">Payouts</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                ...
                <li><a href="/public-contact" className="hover:text-white">Contact</a></li>
              </ul>
            </div>
          </div>
          <div className="border-t border-white/10 pt-8 mb-8">
            <div className="flex flex-wrap justify-center gap-6 text-sm text-white/70">
              <a href="/privacy" className="hover:text-white" data-testid="link-privacy-policy">Privacy Policy</a>
              <a href="/terms" className="hover:text-white" data-testid="link-terms-of-service">Terms of Service</a>
              <a href="/refund-policy" className="hover:text-white" data-testid="link-refund-policy">Refund Policy</a>
              <a href="/cookie-policy" className="hover:text-white" data-testid="link-cookie-policy">Cookie Policy</a>
            </div>
          </div>
